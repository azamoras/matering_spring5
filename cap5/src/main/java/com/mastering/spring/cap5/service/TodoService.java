package com.mastering.spring.cap5.service;
...
import com.mastering.spring.cap5.domain.Todo;
...
public class TodoService {
	...
	static {
		...
		todos.add(new Todo(2, "Jack", "Learn Structs", new Date(), false));
	...
	public  Todo  addTodo(String  name,  String  desc, Date  targetDate,  boolean  isDone)  {      
		Todo  todo  =  new  Todo(
				++todoCount,  name,  desc,  targetDate,  isDone);  
		todos.add(todo);  
		return  todo;
	}
